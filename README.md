...
Portifolio-Gabriel-Pequeno/ ├── css/ │ └── stylesheet.css # Arquivo principal de estilos ├── images/ │ └── ... # Ativos visuais (capas de filme, etc.) ├── index.html # Arquivo principal do site └── README.md # Documentação do projeto

## Como Contribuir ou Usar

Se você deseja usar este código ou testá-lo localmente:
